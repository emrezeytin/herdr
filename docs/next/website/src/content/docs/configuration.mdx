...
`settled_preview` controls how many settled sessions stay visible when the Settled section is collapsed; the rest hide behind "Show N more". It defaults to `3`.
